...
def parse_args():
    ...
    parse.add_argument('--pretrain_vae', type=int, default=0, help='pretrain vae, set to 1 leads to pretrain mode')
    ...
    parse.add_argument('--epoch', type=int, default=20, help='epoch of lightgcn training')
    parse.add_argument('--epoch2', type=int, default=1, help='epoch of vae training')
    parse.add_argument('--lr', type=float, default=0.001, help='learning rate of lightgcn')
    ...
    parse.add_argument('--sc_var', type=float, default=0.04, help='vae score variance')
    parse.add_argument('--eps_decay', type=float, default=0.00125, help='epsilon decay ratio')
    parse.add_argument('--thold', type=float, default=0, help='probability to train vae when no progress in current epoch')
    parse.add_argument('--lambda_', type=float, default=0, help='residual connect coefficient')
